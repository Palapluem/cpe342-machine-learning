...
\begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{Jupyter Notebook: Assignment\_4\_Tree\_and\_Ensemble.ipynb}]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_1_eda_distributions.pdf}
\end{center}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_3_feature_importance.pdf}
\end{center}
\smallskip
\noindent\textbf{Out[9]}:
\begin{lstlisting}[style=output]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_4_confusion_matrices.pdf}
\end{center}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
...
============================================================
               Model Accuracy Admit Prec  ... Waitlist F1 Test AUC 5-Fold CV AUC
0      Decision Tree   61.50%      0.906  ...       0.172   0.5258        0.6178
1      Random Forest   73.00%      0.899  ...       0.129   0.5519        0.6237
2  Gradient Boosting   89.50%      0.904  ...       0.087   0.4981        0.6174
