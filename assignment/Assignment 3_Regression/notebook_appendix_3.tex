...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_2_km_by_payment.pdf}
\end{center}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_3_km_grid_by_payment.pdf}
\end{center}
\smallskip
\noindent\textbf{Out[4]}:
\begin{lstlisting}[style=output]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_4_cumulative_hazard.pdf}
\end{center}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.82\textwidth]{plot_5_churn_distribution.pdf}
\end{center}
\needspace{4\baselineskip}
\vspace{0.8em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=4pt,right=4pt,top=4pt,bottom=4pt,breakable]
