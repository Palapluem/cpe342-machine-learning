...
<>:76: SyntaxWarning: invalid escape sequence '\h'
<>:87: SyntaxWarning: invalid escape sequence '\h'
C:\Users\Admin\AppData\Local\Temp\ipykernel_9784\3103374935.py:31: SyntaxWarning: invalid escap ...
  plt.plot(x_line, y_line, 'r-', linewidth=3, label=f'Fitted Model: $\hat{{y}} = {C0:.2f} + {C1 ...
C:\Users\Admin\AppData\Local\Temp\ipykernel_9784\3103374935.py:47: SyntaxWarning: invalid escap ...
  plt.ylabel('Residuals ($y_i - \hat{y}_i$)')
C:\Users\Admin\AppData\Local\Temp\ipykernel_9784\3103374935.py:76: SyntaxWarning: invalid escap ...
  ax3.plot(x_line, y_line, 'r-', linewidth=3, label=f'Fitted Model: $\hat{{y}} = {C0:.2f} + {C1 ...
C:\Users\Admin\AppData\Local\Temp\ipykernel_9784\3103374935.py:87: SyntaxWarning: invalid escap ...
  ax4.set_ylabel('Residuals ($y_i - \hat{y}_i$)')
\end{lstlisting}
\begin{center}
...
\vspace{1em}
\begin{tcolorbox}[colback=gray!5!white,colframe=gray!50!black,boxrule=0.5pt,arc=2pt,left=2pt,right=2pt,top=2pt,bottom=2pt]
\textbf{\large Bonus: Model Evaluation (R-squared \& Summary Statistics)}\par\smallskip
