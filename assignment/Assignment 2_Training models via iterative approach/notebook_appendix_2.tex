...
<>:76: SyntaxWarning: invalid escape sequence '\h'
<>:87: SyntaxWarning: invalid escape sequence '\h'
C:\Users\Admin\AppData\Local\Temp\ipykernel_9324\3103374935.py:31: SyntaxWarning: invalid escap ...
  plt.plot(x_line, y_line, 'r-', linewidth=3, label=f'Fitted Model: $\hat{{y}} = {C0:.2f} + {C1 ...
C:\Users\Admin\AppData\Local\Temp\ipykernel_9324\3103374935.py:47: SyntaxWarning: invalid escap ...
  plt.ylabel('Residuals ($y_i - \hat{y}_i$)')
C:\Users\Admin\AppData\Local\Temp\ipykernel_9324\3103374935.py:76: SyntaxWarning: invalid escap ...
  ax3.plot(x_line, y_line, 'r-', linewidth=3, label=f'Fitted Model: $\hat{{y}} = {C0:.2f} + {C1 ...
C:\Users\Admin\AppData\Local\Temp\ipykernel_9324\3103374935.py:87: SyntaxWarning: invalid escap ...
  ax4.set_ylabel('Residuals ($y_i - \hat{y}_i$)')
\end{lstlisting}
\begin{center}
