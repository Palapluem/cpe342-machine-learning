...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\textwidth]{nb_out_plot_1.png}
\end{center}
\vspace{1em}
\noindent\textbf{In [11]:}
\begin{lstlisting}[style=pycode]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\textwidth]{nb_out_plot_2.png}
\end{center}
\vspace{1em}
\noindent\textbf{In [12]:}
\begin{lstlisting}[style=pycode]
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.7\textwidth]{nb_out_plot_3.png}
\end{center}