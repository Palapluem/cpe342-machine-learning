...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{regression_analysis.pdf}
    \caption{OLS Linear Regression Analysis \& Residuals — ภาพบนแสดงการกระจายตัวของยอดขายและงบโฆษณาพร้อมเส้นพยากรณ์ ส่วนภาพล่าง (Lollipop Chart) แสดงค่า Residual ของแต่ละจุดข้อมูลอย่างชัดเจน}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{prediction_accuracy.pdf}
    \caption{Model Accuracy: Predicted vs Actual — แสดงความแม่นยำของการพยากรณ์ โดยจุดข้อมูลเกาะกลุ่มอยู่ใกล้เส้น Perfect Prediction อย่างมาก}
\end{figure}
\newpage
...
\noindent
โค้ดสำหรับสร้างกราฟเพื่อนำเสนอผลวิเคราะห์ความสัมพันธ์

\begin{lstlisting}[style=pycode, caption=Code for Unique Data Visualization (plots)]
import numpy as np
import matplotlib
matplotlib.use('Agg')
import matplotlib.pyplot as plt

# Set font to Sarabun for Thai compatibility
...
# ... (Plotting code omitted for brevity. Full code in Assignment_1_OLS.ipynb) ...
\end{lstlisting}

\smallskip
\noindent\textit{\small หมายเหตุ: โค้ดฉบับเต็ม รวมถึงโค้ดสร้างกราฟทั้งหมดและ Output แบบสมบูรณ์สามารถดูได้ใน Jupyter Notebook \texttt{Assignment\_1\_OLS.ipynb} ที่แนบมาด้วย}
