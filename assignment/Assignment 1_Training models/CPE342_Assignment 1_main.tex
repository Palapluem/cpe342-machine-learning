...
\begin{ansbox}
Slope บ่งบอกว่ายอดขาย (Sales) ถูกคาดการณ์ว่าจะเพิ่มตามค่าโฆษณา (Advertising) ที่เพิ่มขึ้น นั่นคือ ทุก ๆ \$1,000 ของ advertising ที่เพิ่มขึ้น จะทำให้ยอดขาย (Sales) เพิ่มขึ้นประมาณ \textbf{1,267 หน่วย}
\end{ansbox}
...
สิ่งนี้บ่งชี้ว่าโมเดล linear regression มี \textbf{ความเหมาะสมดีเยี่ยม (Excellent fit)} กับข้อมูล และตัวงบโฆษณาเป็นปัจจัยพยากรณ์ความสำเร็จของยอดขายที่แข็งแกร่งมาก
\end{ansbox}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{residual_plot.pdf}
    \caption{Residual Plot แสดงค่าความคลาดเคลื่อน (Error) ของแต่ละจุดข้อมูล ซึ่งกระจายตัวรอบศูนย์ได้ดี}
\end{figure}
\newpage
