...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{ชุดกราฟวิเคราะห์พฤติกรรมความคลาดเคลื่อน (Residual Diagnostics) ได้แก่ Lollipop Chart, Residuals vs Fitted, การกระจายตัว (Distribution), Q-Q Plot และ Scale-Location Plot}
\end{figure}
\newpage
