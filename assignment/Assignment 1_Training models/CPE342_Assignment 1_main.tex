...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_1_regression.pdf}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_2_residuals_lollipop.pdf}
    \end{minipage}
    \vspace{0.5cm}
    
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_3_res_vs_fitted.pdf}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_4_res_dist.pdf}
    \end{minipage}
    \vspace{0.5cm}
    
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_5_qq.pdf}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_6_scale_loc.pdf}
    \end{minipage}
    \vspace{0.5cm}

    \begin{minipage}{0.6\textwidth}
        \centering
        \includegraphics[width=\linewidth]{plot_7_actual_vs_pred.pdf}
    \end{minipage}
    \caption{ชุดกราฟวิเคราะห์ 7 รูปแบบ (Diagnostic Plots) ใช้ในการวิเคราะห์พฤติกรรมของข้อมูลและความแม่นยำของโมเดล OLS อย่างละเอียด ตั้งแต่การเปรียบเทียบยอดขายกับงบโฆษณา (1, 7) ไปจนถึงการวิเคราะห์ค่าความคลาดเคลื่อนด้วยวิธีต่างๆ (2, 3, 4, 5, 6) ฟอนต์ Sarabun}
\end{figure}
\newpage
